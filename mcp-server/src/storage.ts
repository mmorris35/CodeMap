...
const SymbolSchema = z.object({
  ...
  kind: z
    ...
    .describe("Type of symbol"),
  file: z.string().describe("Path to file containing symbol"),
  line: z
    .number()
    .int()
    .positive()
    .describe("Line number of symbol definition"),
  column: z
    .number()
    .int()
    .nonnegative()
    .optional()
    .describe("Column number of symbol definition"),
  docstring: z
    .string()
    .nullable()
    .optional()
    .describe("Docstring for the symbol"),
  signature: z.string().optional().describe("Function/method signature"),
  task_links: z
    .array(z.string())
    .optional()
    .describe("Task IDs this symbol implements"),
});
...
export const CodeMapSchema = z.object({
  ...
  dependencies: z
    ...
    .describe("All detected dependencies between symbols"),
...
export class CodeMapStorage {
  ...
  async listProjects(userId: string): Promise<string[]> {
    ...
    return result.keys.map((key: { name: string }) =>
